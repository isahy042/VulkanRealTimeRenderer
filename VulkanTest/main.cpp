...
const string currRepo = "C:/Users/Sasa/Desktop/Spring2024/682Graphics/A0/VulkanRepo/"; // for some reason this needs to be added manually :(
...
private:
	...
	void createGraphicsPipeline() {
		auto vertShaderCode = readFile(currRepo + "shaders/vert.spv");
		auto fragShaderCode = readFile(currRepo + "shaders/frag.spv");
